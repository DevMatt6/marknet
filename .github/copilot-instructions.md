# Marknet — Copilot Instructions

This is a Next.js 16 + React + TypeScript + Tailwind CSS v4 project with Framer Motion, Lenis, shadcn/ui-style components, and bilingual IT/EN content.
...
- Keep code strongly typed and readable
...
## Design
- Maintain a premium, minimal, editorial look
- Avoid generic AI-looking SaaS layouts, noisy gradients, and excessive visual effects
- Use spacing, typography, contrast, and subtle motion intentionally
...
- Prefer composable section-based architecture
- Keep localized text compatible with the existing locale provider and dictionaries
